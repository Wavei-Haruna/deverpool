...
import { FcCollaboration, FcSupport } from "react-icons/fc";
...
export default function HowItWorks() {
  return (
    <main className="my-28 w-full">
      <h1 className=" text-3xl font-bold font-hero">How it Works</h1>
      <section className="grid grid-cols-6 gap-2 mt-10 bg-black text-white">
        <Link to={"/browse-and-discover"} className="bg-[#0b4bef] flex p-3  ">
        ...
        <Link to={"/customization"} className="bg-[#4bb543] flex p-3  ">
          <div className="flex flex-col gap-3 items-center p-2 justify-between">
            <span>
        ...
        <Link to={"/collaboration"} className="bg-[#4bb543] flex p-3  ">
          <div className="flex flex-col gap-3 items-center p-2 justify-between">
            <span>
        ...
        <Link to={"/transaction"} className="bg-[#4bb543] flex p-3  ">
          <div className="flex flex-col gap-3 items-center p-2 justify-between">
            <span>
        ...
        <Link to={"/app-support"} className="bg-[#4bb543] flex p-3  ">
          <div className="flex flex-col gap-3 items-center p-2 justify-between">
            <span>
